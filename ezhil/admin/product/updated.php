...
<body>
    ...
    $id = $_GET['ID'];
    include 'Config.php';
    $Record = mysqli_query($con, "SELECT * FROM `tblproduct1` WHERE id = $id");
...
<div class="main">
        <div class="register">
          ...
          <form id="product" action="updated1.php" method="POST" enctype="multipart/form-data">
             <label>Service Name:</label>
             <br>
             <input type="text" value = "<?php echo $data['Pname']?>" name="Pname" id="name" placeholder="Enter Service name" required="required">
             <br><br>
             <label>Service price:</label>
             <br>
             <input type="text" value = "<?php echo $data['Pprice']?>" name="Pprice" id="name" placeholder="Enter Service price" required="required">
             <br><br>
