...
<body>
    <div class="main">
        <div class="register">
          ...
          <form id="product" action="insert1.php" method="POST" enctype="multipart/form-data">
    ...
    <table class="table table-dark table-hover border my-5 ">
        ...
        <tbody>
            <?php
                include 'Config.php';
                $Record = mysqli_query($con,"SELECT * FROM `tblproduct1`");
                ...
                <td>$row[Pcategory]</td>
                <td><a href='delete1.php?ID=$row[id]' class = 'bg-danger btn btn-outline-white fs-16px fw-bold text-white'>DELETE</td>
                <td><a href='updated.php?ID=$row[id]' class = 'bg-green btn btn-outline-white fs-16px fw-bold text-white' style='background:green;'>UPDATE</td>
                </tr>
