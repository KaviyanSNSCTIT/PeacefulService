    ...
    <div class="main">
        <div class="register">
          ...
          <form id="product" action="insert.php" method="POST" enctype="multipart/form-data">
             ...
             <br>
             <input type="text" name="Pname" id="name" placeholder="Enter Service name" required="required">
             <br><br>
             <label>Service price:</label>
             <br>
             <input type="text" name="Pprice" id="name" placeholder="Enter Service price" required="required">
             <br><br>
