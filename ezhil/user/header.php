...
<body>
    ...
    <header>
    <a href="../homepage/advdfr.html" class="novius">Peaceful Service</a>
        <nav class="jin">
            <ul class="nav_links">
        ...
        <div class="category">
            <ul class="category_links">
                <li><a href="jk.php">General Service</a></li>
                <li><a href="billing.php">Engine Service</a></li>
                <li><a href="pos.php">Others</a></li>
            </ul>
        </div>
